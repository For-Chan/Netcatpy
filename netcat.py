...
import shlex
import subprocess
#subprocess - provides powerful process-creation interface
# that gives number of ways to interact with client programs
import sys
import textwrap
import threading
...
def execute(cmd):
    ...
    if not cmd:
        return
    '''
    check_output method, which runs a command on the LOCAL OS
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='BHP Net Tool',
                                     ...
                                     netcat.py -t IP -p PORT -l -u=mytest.txt # upload a file
